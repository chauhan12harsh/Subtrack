...
public class Subscription {
    ...
    public Subscription(UUID userId, String name, BigDecimal amount, String category, BillingCycle cycle,
            Instant next) {
        this.userId = userId;
        this.name = name;
        this.amount = amount;
    ...
    public void update(String name, BigDecimal amount, String category, BillingCycle cycle, Instant next) {
        if (name != null)
            this.name = name;
        if (amount != null)
            this.amount = amount;
