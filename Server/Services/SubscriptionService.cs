...
using SubTrack.Data;
using SubTrack.Dtos.Subscription;
...
namespace SubTrack.Subscriptions.Services
{
    public class SubscriptionService(ApplicationDbContext context) : ISubscriptionService
    {
        public async Task<SubscriptionResponseDto> CreateSubscription(CreateSubscriptionDto createSubscriptionDto, Guid userId)
        {
            ...
            {
                throw new AlreadyExistsException("Subscription already exist's.");
            }
        ...
        public async Task<string> UpdateSubscriptionStatus(Guid subscriptionid, BillingStatus status, Guid userId)
        {
            ...
            {
                throw new AlreadyUpdatedException($"Status is already {status}");
            }
