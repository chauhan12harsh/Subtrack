...
namespace SubTrack.Notifications.Services
{
    public class NotificationService(ApplicationDbContext context) : INotificationService
    {
        ...
        public async Task<string> ReadAllNotifications(Guid userId)
        {
            ...
            {
                throw new AlreadyUpdatedException("All Notifications are already seen");
            }
        ...
        public async Task<string> ReadNotification(Guid notificationId, Guid userId)
        {
            ...
            {
                throw new AlreadyUpdatedException("Notification already seen");
            }
